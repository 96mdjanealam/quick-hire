        ...
        {error || !job ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Header */}
              <div className="bg-white p-8 rounded-xl shadow-sm border border-card-border">
                <div className="flex items-start gap-6">
                  <div className="w-16 h-16 relative rounded-xl overflow-hidden bg-zinc-50 flex items-center justify-center shrink-0 border border-card-border">
                    {job.company_logo ? (
                      <Image
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-card-border sticky top-24">
                <h3 className="text-lg font-bold text-zinc-900 mb-6 font-clash border-b border-card-border pb-4">
                  Apply for this job
                </h3>
                <ApplicationForm jobId={job._id} />

                <div className="mt-8 pt-6 border-t border-card-border text-xs text-zinc-400 flex items-center gap-2">
                  <Calendar size={14} />
